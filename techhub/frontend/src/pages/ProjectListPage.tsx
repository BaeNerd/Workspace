...
const MOCK_ASSET_ITEMS: AssetItem[] = [
  { id: "N8N-2026-001", categoryId: "n8n", title: "신규 입사자 계정 자동 생성", summary: "HR 시스템 입력 시 AD/Teams/이메일 계정을 자동 생성", description: "", status: "사용 가능", dept: "IT인프라팀", company: ["KKM"], owner: "이서현", ownerEmail: "seohyun.lee@kolmar.co.kr", tags: ["HR", "계정자동화", "온보딩"], specificUrl: "https://n8n.kolmar.co.kr/workflow/001", updatedAt: "2025.06.05", likes: 19, domain: "IT" },
  { id: "N8N-2026-002", categoryId: "n8n", title: "발주 승인 알림 자동화", summary: "구매 시스템의 발주 승인 요청을 Teams로 즉시 알림", description: "", status: "사용 가능", dept: "구매팀", company: ["KKM"], owner: "박성훈", ownerEmail: "sunghoon.park@kolmar.co.kr", tags: ["구매", "승인알림", "ERP연동"], specificUrl: "https://n8n.kolmar.co.kr/workflow/002", updatedAt: "2025.06.08", likes: 7, domain: "생산" },
  { id: "N8N-2026-003", categoryId: "n8n", title: "일일 매출 리포트 자동 발송", summary: "매일 오전 9시 전일 매출 요약을 경영진에게 자동 발송", description: "", status: "사용 가능", dept: "재무팀", company: ["KKM", "KMG"], owner: "김재원", ownerEmail: "jaewon.kim@kolmar.co.kr", tags: ["매출리포트", "ERP", "자동발송"], specificUrl: "https://n8n.kolmar.co.kr/workflow/003", updatedAt: "2025.06.12", likes: 12, domain: "재무" },
  { id: "N8N-2026-004", categoryId: "n8n", title: "품질 이슈 발생 시 즉시 에스컬레이션", summary: "품질관리 시스템 이상 감지 시 관련 부서에 즉시 알림", description: "", status: "준비 중", dept: "품질관리팀", company: ["KMW"], owner: "이민호", ownerEmail: "minho.lee@kolmar.co.kr", tags: ["품질관리", "에스컬레이션", "생산"], specificUrl: "https://n8n.kolmar.co.kr/workflow/004", updatedAt: "2025.06.18", likes: 3, domain: "생산" },
  ...
  { id: "PA-2026-002", categoryId: "pa", title: "양식 제출 → Teams 알림 플로우", summary: "Microsoft Forms 제출 시 담당자에게 Teams 메시지 및 이메일 동시 발송", description: "", status: "사용 가능", dept: "인사팀", company: [], owner: "김민지", ownerEmail: "minji.kim@kolmar.co.kr", tags: ["Forms", "Teams", "알림"], specificUrl: "", updatedAt: "2025.06.15", likes: 8, usageMode: "contact", domain: "HR" },
  { id: "AST-2026-001", categoryId: "assistant", title: "법무 검토 보조 봇", summary: "계약서 초안의 위험 조항을 자동으로 식별하고 검토 의견 제시", description: "", status: "사용 가능", dept: "법무팀", company: [], owner: "강현우", ownerEmail: "hyunwoo.kang@kolmar.co.kr", tags: ["법무", "계약서검토", "위험분석"], specificUrl: "https://assistant.kolmar.co.kr/agents/legal-review", updatedAt: "2025.06.10", likes: 25, domain: "재무" },
  { id: "AST-2026-002", categoryId: "assistant", title: "회의록 요약 봇", summary: "Teams 회의 녹취록을 업로드하면 핵심 결정사항을 자동 정리", description: "", status: "사용 가능", dept: "IT개발팀", company: [], owner: "정태영", ownerEmail: "taeyoung.jung@kolmar.co.kr", tags: ["회의록", "요약", "Teams연동"], specificUrl: "https://assistant.kolmar.co.kr/agents/meeting-summary", updatedAt: "2025.06.14", likes: 18, domain: "IT" },
  { id: "AST-2026-003", categoryId: "assistant", title: "코드 리뷰 어시스턴트", summary: "GitHub PR에 자동으로 코드 리뷰 코멘트를 남기는 봇", description: "", status: "준비 중", dept: "IT개발팀", company: [], owner: "정태영", ownerEmail: "taeyoung.jung@kolmar.co.kr", tags: ["코드리뷰", "GitHub", "개발도구"], specificUrl: "https://assistant.kolmar.co.kr/agents/code-review", updatedAt: "2025.06.19", likes: 10, domain: "IT" },
  { id: "AST-2026-004", categoryId: "assistant", title: "원료 안전성 문의 봇", summary: "원료의 MSDS·규제 정보를 빠르게 조회하는 연구원용 봇", description: "", status: "준비 중", dept: "메이크업연구소", company: ["KKM"], owner: "이수연", ownerEmail: "suyeon.lee@kolmar.co.kr", tags: ["원료", "MSDS", "규제정보"], specificUrl: "https://assistant.kolmar.co.kr/agents/ingredient-safety", updatedAt: "2025.06.20", likes: 5, domain: "연구" },
  ...
  {
    id: "ML-2026-001", categoryId: "ml", title: "조색 예측 ML 모델", summary: "원료 배합 비율로 최종 색상을 예측하는 회귀 모델", description: "",
  ...
  {
    id: "ML-2026-002", categoryId: "ml", title: "원료 수요 예측 모델", summary: "과거 생산·판매 데이터를 기반으로 월별 원료 수요를 예측", description: "",
  ...
  {
    id: "VIBE-2026-001", categoryId: "vibe", title: "일일 판매 리포트 자동 생성기", summary: "ERP 데이터를 읽어 매일 아침 판매 실적 요약을 Slack으로 발송", description: "",
  ...
  {
    id: "VIBE-2026-002", categoryId: "vibe", title: "원가 분석 자동화 스크립트", summary: "ChatGPT로 작성한 Python 스크립트로 ERP 원가 데이터 자동 분석 및 리포트 생성", description: "",
  ...
  // 추가 n8n
  { id: "N8N-2026-005", categoryId: "n8n", title: "Outlook 긴급 메일 자동 전달", summary: "긴급 키워드 메일 수신 시 팀장에게 즉시 자동 전달", description: "", status: "사용 가능", dept: "IT인프라팀", company: ["KKM"], owner: "이서현", ownerEmail: "seohyun.lee@kolmar.co.kr", tags: ["Outlook", "긴급메일", "알림"], specificUrl: "https://n8n.kolmar.co.kr/workflow/005", updatedAt: "2025.07.03", likes: 22, domain: "IT" },
  { id: "N8N-2026-006", categoryId: "n8n", title: "주간 재고 현황 자동 취합", summary: "매주 월요일 각 창고의 재고 데이터를 취합해 경영진에게 요약 메일 발송", description: "", status: "사용 가능", dept: "구매팀", company: ["KKM", "KBH"], owner: "박성훈", ownerEmail: "sunghoon.park@kolmar.co.kr", tags: ["재고관리", "ERP", "자동발송"], specificUrl: "https://n8n.kolmar.co.kr/workflow/006", updatedAt: "2025.07.02", likes: 8, domain: "생산" },
  { id: "N8N-2026-007", categoryId: "n8n", title: "연구원 출장 신청 자동 처리", summary: "출장 신청서 제출 시 결재 라인을 자동으로 설정하고 일정·항공편 조회 링크 발송", description: "", status: "준비 중", dept: "메이크업연구소", company: ["KKM"], owner: "이수연", ownerEmail: "suyeon.lee@kolmar.co.kr", tags: ["출장관리", "HR", "일정"], specificUrl: "", updatedAt: "2025.06.25", likes: 5, usageMode: "contact", domain: "연구" },
  { id: "N8N-2026-008", categoryId: "n8n", title: "생산 실적 KPI 일일 집계", summary: "생산 시스템에서 라인별 실적을 자동 집계해 품질·생산팀에 공유", description: "", status: "사용 가능", dept: "품질관리팀", company: ["KKM", "KMW"], owner: "이민호", ownerEmail: "minho.lee@kolmar.co.kr", tags: ["생산실적", "KPI", "집계"], specificUrl: "https://n8n.kolmar.co.kr/workflow/008", updatedAt: "2025.07.05", likes: 10, domain: "생산" },
  // 추가 Power Automate
  ...
  { id: "PA-2026-004", categoryId: "pa", title: "재고 부족 알림 자동화", summary: "ERP 재고 수준이 기준치 이하로 내려가면 구매 담당자에게 즉시 Teams 알림 발송", description: "", status: "준비 중", dept: "구매팀", company: ["KKM"], owner: "박성훈", ownerEmail: "sunghoon.park@kolmar.co.kr", tags: ["재고관리", "ERP", "알림"], specificUrl: "", updatedAt: "2025.06.22", likes: 7, usageMode: "contact", domain: "생산" },
  ...
  { id: "PA-2026-006", categoryId: "pa", title: "신규 공급사 등록 승인 워크플로우", summary: "신규 공급사 등록 요청 시 구매·재무·법무 순서로 단계별 승인 자동 진행", description: "", status: "준비 중", dept: "구매팀", company: ["KKM", "KBH", "HC"], owner: "박성훈", ownerEmail: "sunghoon.park@kolmar.co.kr", tags: ["공급사관리", "승인워크플로우", "ERP"], specificUrl: "", updatedAt: "2025.06.28", likes: 6, usageMode: "contact", domain: "생산" },
  // 추가 나만의 비서
  ...
  { id: "AST-2026-007", categoryId: "assistant", title: "원자재 가격 동향 요약 봇", summary: "원자재 뉴스와 공시 데이터를 분석해 구매팀에 주요 가격 변동 동향 요약 제공", description: "", status: "준비 중", dept: "구매팀", company: ["KKM", "KBH"], owner: "이재훈", ownerEmail: "jaehoon.lee@kolmar.co.kr", tags: ["원자재", "가격분석", "구매"], specificUrl: "", updatedAt: "2025.06.30", likes: 8, usageMode: "contact", domain: "생산" },
  // 추가 ML 모델
  {
    id: "ML-2026-003", categoryId: "ml", title: "불량품 이미지 분류 모델", summary: "생산 라인 카메라 이미지로 불량품을 실시간 자동 판별하는 CNN 모델", description: "",
  ...
  {
    id: "ML-2026-004", categoryId: "ml", title: "처방 성분 상호작용 예측 모델", summary: "의약품 성분 조합의 부작용 가능성을 예측하는 분류 모델", description: "",
  ...
  {
    id: "ML-2026-005", categoryId: "ml", title: "판매 채널별 수요 예측 모델", summary: "온라인·오프라인·홈쇼핑 채널별 제품 수요를 동시에 예측하는 다변량 시계열 모델", description: "",
  ...
  // 추가 Vibe Coding
  {
    id: "VIBE-2026-003", categoryId: "vibe", title: "부서별 KPI 현황판 자동화", summary: "Excel KPI 데이터를 읽어 자동으로 부서별 성과 대시보드를 그려주는 Python 앱", description: "",
  ...
  {
    id: "VIBE-2026-004", categoryId: "vibe", title: "커피 룰렛 웹앱", summary: "팀원 명단을 업로드하면 커피 당번을 무작위 선정하는 인트라넷 미니앱", description: "",
  ...
  {
    id: "VIBE-2026-005", categoryId: "vibe", title: "ECM 멀티 파일 다운로더", summary: "ECM에서 여러 파일을 한 번에 선택하고 다운로드하는 유틸리티 프로그램", description: "",
  ...
  { id: "AST-2026-009", categoryId: "assistant", title: "초기 법무 계약 검토 봇 (v1)", summary: "계약서 위험 조항을 식별하던 초기 법무 보조 봇 (현 AST-2026-001의 전신)", description: "", status: "사용 중지", dept: "법무팀", company: [], owner: "강현우", ownerEmail: "hyunwoo.kang@kolmar.co.kr", tags: ["계약서검토", "법무", "레거시"], specificUrl: "", updatedAt: "2025.12.01", likes: 3, statusNote: "최신 모델 기반 법무 검토 보조 봇(AST-2026-001)으로 완전 대체. 2025년 12월 서비스 종료 및 데이터 이관 완료", domain: "재무" },
  {
    id: "VIBE-2026-006", categoryId: "vibe", title: "Excel VBA 주간 원가 정산 도구", summary: "ChatGPT가 작성한 VBA 매크로로 주간 원가 데이터를 자동 집계하던 도구", description: "",
...
const POPULAR_TAGS: string[] = (() => {
  ...
  MOCK_ASSET_ITEMS.forEach(item => item.tags.forEach(t => freq.set(t, (freq.get(t) ?? 0) + 1)));
