...
import type { PlatformItem, PlatformId, PlatformReview } from "../types/platformTypes";
...
const detailTabLabelFor = (platformId: PlatformId): string => {
  ...
  if (platformId === "vibe") return "제작 이야기";
  if (platformId === "etc") return "프로젝트 소개";
  return "상세 동작"; // n8n
};
...
const MOCK_ITEMS: PlatformItem[] = [
  {
    id: "N8N-2026-001", platformId: "n8n",
  ...
  {
    id: "N8N-2026-002", platformId: "n8n",
    title: "발주 승인 알림 자동화",
  ...
  {
    id: "N8N-2026-003", platformId: "n8n",
  ...
  {
    id: "N8N-2026-004", platformId: "n8n",
  ...
  {
    id: "VIBE-2026-001", platformId: "vibe",
  ...
  {
    id: "AST-2026-001", platformId: "assistant", title: "법무 검토 보조 봇",
  ...
  {
    id: "AST-2026-002", platformId: "assistant", title: "회의록 요약 봇",
  ...
  {
    id: "AST-2026-003", platformId: "assistant", title: "코드 리뷰 어시스턴트",
  ...
  {
    id: "AST-2026-004", platformId: "assistant", title: "원료 안전성 문의 봇",
  ...
  {
    id: "AIO-2026-010", platformId: "ai-orchestration", agentAvailability: "사용 가능", title: "웍스 대표 모델",
  ...
  {
    id: "VIBE-2026-002", platformId: "vibe",
  ...
  // ── 추가 n8n ──────────────────────────────────────────────────────────────
  { id: "N8N-2026-005", platformId: "n8n", title: "Outlook 긴급 메일 자동 전달",
  ...
  { id: "N8N-2026-006", platformId: "n8n", title: "주간 재고 현황 자동 취합",
  ...
  { id: "N8N-2026-007", platformId: "n8n", title: "연구원 출장 신청 자동 처리",
  ...
  { id: "N8N-2026-008", platformId: "n8n", title: "생산 실적 KPI 일일 집계",
  ...
  { id: "N8N-2026-009", platformId: "n8n", title: "SAP 전표 오류 실시간 알림",
  ...
  { id: "N8N-2026-010", platformId: "n8n", title: "구 Slack 장애 알림 자동화",
  ...
  // ── 추가 Power Automate ────────────────────────────────────────────────────
  { id: "PA-2026-004", platformId: "pa", title: "재고 부족 알림 자동화",
  ...
  { id: "PA-2026-005", platformId: "pa", title: "계약 만료 사전 알림 플로우",
  ...
  { id: "PA-2026-006", platformId: "pa", title: "신규 공급사 등록 승인 워크플로우",
  ...
  { id: "PA-2026-007", platformId: "pa", title: "임직원 경비 청구 자동 검증",
  ...
  { id: "PA-2026-008", platformId: "pa", title: "수기 설비 점검 기록 디지털화",
  ...
  // ── 추가 나만의 비서 ───────────────────────────────────────────────────────
  { id: "AST-2026-005", platformId: "assistant", title: "영업 제안서 초안 봇",
  ...
  { id: "AST-2026-006", platformId: "assistant", title: "HR 정책 문답 봇",
  ...
  { id: "AST-2026-007", platformId: "assistant", title: "원자재 가격 동향 요약 봇",
  ...
  { id: "AST-2026-008", platformId: "assistant", title: "구매 단가 협상 전략 봇",
  ...
  { id: "AST-2026-009", platformId: "assistant", title: "초기 법무 계약 검토 봇 (v1)",
  ...
  // ── 추가 ML 모델 ──────────────────────────────────────────────────────────
  { id: "ML-2026-003", platformId: "ml", title: "불량품 이미지 분류 모델",
  ...
  { id: "ML-2026-004", platformId: "ml", title: "처방 성분 상호작용 예측 모델",
  ...
  { id: "ML-2026-005", platformId: "ml", title: "판매 채널별 수요 예측 모델",
  ...
  // ── 추가 Vibe Coding ──────────────────────────────────────────────────────
  { id: "VIBE-2026-003", platformId: "vibe", title: "부서별 KPI 현황판 자동화",
  ...
  { id: "VIBE-2026-004", platformId: "vibe", title: "커피 룰렛 웹앱",
  ...
  { id: "VIBE-2026-005", platformId: "vibe", title: "ECM 멀티 파일 다운로더",
  ...
  { id: "VIBE-2026-006", platformId: "vibe", title: "Excel VBA 주간 원가 정산 도구",
  ...
  // ── 기타 (블로그형 소규모 프로젝트) ──────────────────────────────────────────
  { id: "ETC-2026-001", platformId: "etc", title: "사내 뉴스 한눈에 요약 미니 프로젝트",
    ...
    status: "사용 가능", dept: "DX전략팀", owner: "박직원", ownerEmail: "jiik.jung@kolmar.co.kr",
    tags: ["사이드프로젝트", "요약", "블로그"], specificUrl: "", updatedAt: "2026.07.10", likes: 5, company: [],
    images: [PLACEHOLDER_IMG_1, PLACEHOLDER_IMG_2],
  },
];
...
export default function PlatformItemDetailPage() {
  ...
  const hasDetailTab = item.platformId !== "vibe" && item.platformId !== "etc";

  const TABS = [
    { id: "overview" as const, label: "개요" },
    ...(hasDetailTab ? [{ id: "detail" as const, label: detailTabLabelFor(item.platformId) }] : []),
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 16 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                ...
                {item.platformId === "ai-orchestration" && item.agentAvailability && (
            ...
            <div style={{ display: "flex", gap: 8, flexShrink: 0, alignItems: "center" }}>
              ...
              {item.platformId === "ai-orchestration" && item.specificUrl && (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {item.platformId === "ai-orchestration" && item.modelMeta && (
              <div style={{ background: "#fff", border: "1.5px solid #EBEEF3", borderRadius: 10, padding: "24px 26px" }}>
                ...
                {item.specificUrl && (
                  <button onClick={() => window.open(item.specificUrl, "_blank")} style={{
                    background: platform.color, color: "#fff", border: "none", borderRadius: 7,
