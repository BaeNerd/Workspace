    ...
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <button
          ...
          style={{ background: "transparent", color: COLOR.text2, border: `1px solid ${COLOR.border}`, borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 500, cursor: "pointer" }}
        >로그아웃</button>
      </div>
    </nav>
  );
