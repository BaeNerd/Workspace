...
export const MOCK_ASSET_ITEMS: AssetItem[] = [
  ...
  },
  {
    ...
    expectedTimeSaved: "건당 15~20분 절약",
    difficulty: "보통",
    domain: "연구",
    usageMode: "contact",
  },
  ...
  },
  {
    ...
    expectedTimeSaved: "오류 인지 시간 평균 30분 단축",
    difficulty: "어려움",
    domain: "재무",
    usageMode: "contact",
