          ...
          <Section title="최종 확인">
            ...
            {summaryRows.map((row, i) => (
              <div key={i} style={{
                ...
                <span style={{ fontSize: 13, color: "#1A1F27", whiteSpace: "pre-wrap" }}>{row.value}</span>
              </div>
            ))}

            {kind && (
              <div style={{ background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: 8, padding: "12px 16px", marginTop: 16, fontSize: 12, color: "#1E40AF" }}>
